...
- Last synchronized snapshot (UTC): `2026-09-05T00:56:10+00:00`.
...
- Completed epochs: `19/60`.
- Latest EMA P1/P2: `39.0107/32.7743 mm` at epoch 19.
- Best EMA P1 and paired P2: `39.0107/32.7743 mm` at epoch 19.
- Current iteration trace: unavailable or waiting to start.
- Error matches: `0`.
- Latest pre-clip gradient norm: `2.9158` (configured max norm `1.0`).
- Latest train throughput: `2.773 it/s`.
- Stable mean throughput: `3.166 it/s`.
- Trainer peak reserved VRAM: `21140 MiB`.
- Latest maximum pre-clip gradient norm: `7.4621`; clipped-step fraction `96.91%`.
- Latest raw parameter movement: relative L2 `2.5049%`, max absolute `0.185044`.
- External monitor latest total GPU memory/utilization: `25497 MiB / 100%`.
