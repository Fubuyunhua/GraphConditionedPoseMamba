...
SOURCE = Path('/scratch/home/caiwei/GraphConditionedPoseMamba_W256_SELECTIVE_FT_B2_20260909/runs/w256_selective_ft_b2_20260909/seed0_2026_09_09_T_07_24_04/best_ema_epoch.bin')
EXPECTED = '31540f2570a41de072e68456dfe7960a4d6e62e6dcd0d38f3519e00ad006ea54'
...
def main():
    ...
    assert 0 < trainable_count < 20192451
    assert all(p.requires_grad == n.startswith(('blocks.14.', 'blocks.15.', 'head.')) for n,p in model.named_parameters())
    ...
    for batch in (1, 2):
        ...
        assert math.isclose(schedule.scale_at(0) * c.learning_rate, 5e-8)
        ...
        for prefix in ('blocks.14.', 'blocks.15.', 'head.'):
        ...
        for group, initial_lr in zip(optimizer.param_groups, schedule.base_lrs):
            ...
            assert math.isclose(group['lr'], expected_lr * schedule.scale_at(1))
