...
def main():
    cfg='configs/pose3d/graph_posemamba_h36m_w128_d10_balanced_gt2d_80e.yaml'
    c=get_config(cfg)
    ...
    report['status']='PASS'
    (out/'w128_d10_balanced_gt2d_preflight.json').write_text(json.dumps(report,indent=2))
