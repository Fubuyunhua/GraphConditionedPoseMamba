...
> **2026-09-06 update:** E-RWG-0 and E-NR-0 completed and support anatomical topology/independent recurrence for seed0. Corrected PoseMamba completed with best EMA `40.660688/33.532125 mm`, `+0.434666 mm` P1 worse than released seed0, so it remains a separate implementation diagnostic rather than an accuracy replacement. MPI Full is the current formal run under per-epoch test-best selection. See [.experiments/paper_remaining_evidence/CURRENT_HANDOFF_20260906.md](.experiments/paper_remaining_evidence/CURRENT_HANDOFF_20260906.md).
