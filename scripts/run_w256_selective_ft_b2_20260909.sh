#!/usr/bin/env bash
set -euo pipefail
cd /scratch/home/caiwei/GraphConditionedPoseMamba_W256_SELECTIVE_FT_B2_20260909
...
"$py" -u tools/preflight_w256_selective_ft.py
...
set +e
"$py" -u train.py --config "$config" --checkpoint runs/w256_selective_ft_b2_20260909/seed0 --pretrained initializers --selection r3_best_ema.bin --seed 0
code=$?
