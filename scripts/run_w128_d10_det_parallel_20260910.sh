#!/usr/bin/env bash
set -euo pipefail
cd /scratch/home/caiwei/GraphConditionedPoseMamba_W128_D10_DET_PARALLEL_20260910
...
"$py" -u tools/preflight_w128_d10_det_parallel.py
touch verification/formal_started
set +e
"$py" -u train.py --config configs/pose3d/graph_posemamba_h36m_w128_d10_balanced_det2d_80e.yaml --checkpoint runs/w128_d10_balanced_20260910/det2d_seed0 --seed 0
code=$?
