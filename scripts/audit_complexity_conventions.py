...
def model_specs(all_models=False):
    specs=[('GCS-Pose-W64D8','configs/gcs_pose/detector/w64d8.yaml',800083),
           ('GCS-Pose-W128D10','configs/gcs_pose/detector/w128d10.yaml',3435395),
           ('GCS-Pose-W128D20','configs/gcs_pose/detector/w128d20.yaml',6836355)]
    return specs
